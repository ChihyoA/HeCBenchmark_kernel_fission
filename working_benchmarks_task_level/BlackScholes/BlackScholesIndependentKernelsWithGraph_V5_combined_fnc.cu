...
int main(int argc, char **argv)
{
    ...
    */
    ...
    void* kernelArgs_X[] = { &d_CallResult, &d_PutResult, &d_StockPrice, 
                            ...
                            (void*)&RISKFREE, (void*)&VOLATILITY, &OPT_N, &iterations,  (void*)&x_y_variable };
    kernelNodeParams_X.func = (void*)BlackScholesGPUWithTweak;
    ...
    void* kernelArgs_Y[] = { &d_CallResult, &d_PutResult, &d_StockPrice, 
                            &d_OptionStrike, &d_OptionYears, 
                            (void*)&RISKFREE, (void*)&VOLATILITY, &OPT_N, &iterations, (void*)&x_y_variable };
    kernelNodeParams_Y.func = (void*)BlackScholesGPUWithTweak;
