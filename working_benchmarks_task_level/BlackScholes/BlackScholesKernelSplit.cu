...
int main(int argc, char **argv)
{
    ...
    *d_OptionYears;
    ...
    {
        BlackScholesGPU_X<<<DIV_UP((OPT_N/2), threadsPerBlock), threadsPerBlock /*480, 128*/, 0, stream1>>>(
            (float2 *)d_CallResult,
            (float2 *)d_PutResult,
            (float2 *)d_StockPrice,
        ...
        BlackScholesGPU_Y<<<DIV_UP((OPT_N/2), threadsPerBlock), threadsPerBlock /*480, 128*/, 0, stream2>>>(
            (float2 *)d_CallResult,
            (float2 *)d_PutResult,
            (float2 *)d_StockPrice,
            (float2 *)d_OptionStrike,
