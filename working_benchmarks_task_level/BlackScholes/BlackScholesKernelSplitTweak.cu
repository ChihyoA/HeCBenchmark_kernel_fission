...
////////////////////////////////////////////////////////////////////////////////
#include "BlackScholes_kernel_split_tweak.cuh"
...
int main(int argc, char **argv)
{
    ...
    *d_OptionYears;
    ...
    {
        BlackScholesGPUWithTweak<<<DIV_UP((OPT_N/2), threadsPerBlock), threadsPerBlock /*480, 128*/, 0, stream1>>>(
            (float2 *)d_CallResult,
            (float2 *)d_PutResult,
            (float2 *)d_StockPrice,
	...
	BlackScholesGPUWithTweak<<<DIV_UP((OPT_N/2), threadsPerBlock), threadsPerBlock /*480, 128*/, 0, stream2>>>(
            (float2 *)d_CallResult,
            (float2 *)d_PutResult,
            (float2 *)d_StockPrice,
            (float2 *)d_OptionStrike,
    ...
    printf("Kernel execution time: %f msec\n", kernelTime);
